...
// Lens Network
// export const LENS_NETWORK = process.env.NEXT_PUBLIC_LENS_NETWORK ?? 'testnet';
...
// Application
export const APP_NAME = 'PreshMail';
export const DESCRIPTION =
  'PreshMail is a decentralized messageing app built with Lens Protocol, XMTP and many other great technologies';
export const DEFAULT_OG = 'https://images.google.com/images/branding/googlelogo/1x/googlelogo_light_color_272x92dp.png';

// Git
export const GIT_COMMIT_SHA = process.env.NEXT_PUBLIC_VERCEL_GIT_COMMIT_SHA?.slice(0, 7);

// Misc
export const CONTACT_EMAIL = 'support@preshmail.com';
